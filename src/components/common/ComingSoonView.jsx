...
import ProviderSignupForm from './ProviderSignupForm.jsx';
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen p-4 text-center bg-gray-900 text-white overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <h1 className="text-5xl md:text-7xl font-bold text-white mb-3 tracking-tight animate-pulse-shadow">Master Party</h1>
                <p className="text-xl md:text-2xl font-light text-pink-400 mb-12">El control maestro de tu celebración.</p>
                <p className="text-2xl md:text-3xl font-light animate-pulse text-shadow-custom">Muy pronto...</p>
            </div>
            ...
            {/* Correo de contacto */}
            <div className="relative z-10 mt-8 text-gray-400">
                <p>Para ayuda o información, contáctanos en <a href="mailto:contacto@masterparty.mx" className="font-semibold text-violet-300 hover:underline">contacto@masterparty.mx</a></p>
            </div>
        </div>
    );
};
