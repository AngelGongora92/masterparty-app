...
import MaintenanceView from './components/common/MaintenanceView.jsx';
import ProviderSignupForm from './components/common/ProviderSignupForm.jsx';
import ComingSoonView from './components/common/ComingSoonView.jsx';
...
export default function App() {
    ...
    // Usamos un switch para renderizar la vista correcta según el modo.
    // Esto es muy fácil de extender en el futuro.
    switch (appMode) {
        case 'comingsoon':
        ...
        case 'live':
        default:
            // Si el modo es 'live' o cualquier otro valor no reconocido, muestra la app completa.
            return (
                <AuthProvider>
                    <BrowserRouter>
                        <AppContent />
